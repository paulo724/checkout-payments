...
<body>
    ...
    <div class="grid sm:px-10 lg:grid-cols-2 lg:px-20 xl:px-32 bg-gray-50">
        <div class="px-4 pt-8 ">
            ...
            <form class="form" x-data="useForm" x-on:submit.prevent="post">
                <div class="form-response" style="display: none" x-show="response" x-bind:class="`is-${response?.state?.type}`" x-text="response?.state?.message" x-transition></div>
        ...
        <div class="mt-10 px-4 pt-8 lg:mt-0 bg-white ">
            <img src="https://app.pwrsaude.com.br/img/logo_pwrsaude-min.png">
